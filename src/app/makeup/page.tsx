...
const ProductsList = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const query = '*[_type == "makeup"]{_id, productName, price, category, slug, status, description, "image": image.asset->url, colors}'
  ...
  return (
    <div>
        <h1 className="text-2xl sm:text-1xl font-bold mt-[8px] text-center"> GIRLS MAKE UP</h1>
